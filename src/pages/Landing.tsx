...
import { Users, Recycle, TrendingUp, Award, Shield, Smartphone, Facebook, Twitter, Instagram, Linkedin } from "lucide-react";
...
const Landing = ({ onUserTypeSelect }: LandingProps) => {
  const features = [
    { icon: <Users className="h-6 w-6" />, title: "Community Engagement", description: "Join millions of Indians in the clean India mission" },
    { icon: <Recycle className="h-6 w-6" />, title: "Smart Segregation", description: "Learn proper waste sorting with AI-powered guidance" },
    { icon: <TrendingUp className="h-6 w-6" />, title: "Progress Tracking", description: "Monitor your environmental impact in real-time" },
    { icon: <Award className="h-6 w-6" />, title: "Rewards System", description: "Earn points and rewards for sustainable actions" },
    { icon: <Shield className="h-6 w-6" />, title: "Transparency", description: "Full transparency in waste management processes" },
    { icon: <Smartphone className="h-6 w-6" />, title: "Digital First", description: "Modern digital platform for seamless experience" },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden text-white">
        ...
        <div className="relative z-10 container mx-auto px-4 py-24 text-center">
          ...
          >
            Join the nationwide digital platform tackling India's waste crisis through education, gamification, and transparency. Every person matters.
          </motion.p>
      ...
      <section className="relative py-20 bg-gradient-to-r from-green-100 via-green-50 to-green-100 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          >
            We are on a mission to inspire citizens across India to embrace sustainability, tackle waste challenges, and build a cleaner, greener future—together. 🌍
          </motion.p>
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold text-green-900">
              <Typewriter
                ...
                loop={0} cursor cursorStyle="|" typeSpeed={100} deleteSpeed={60} delaySpeed={1500}
              />
            </h3>
          ...
          >
            <div className="flex items-center gap-2"><Recycle className="h-6 w-6" /> <span>Reduce Waste</span></div>
            <div className="flex items-center gap-2"><Users className="h-6 w-6" /> <span>Empower Communities</span></div>
            <div className="flex items-center gap-2"><Smartphone className="h-6 w-6" /> <span>Go Digital</span></div>
          </motion.div>
        </div>
      </section>
